...
// Function to create invoice with overlaid text
    ...
    try {
        ...
        const svgOverlay = `
            <svg width="${width}" height="${height}" xmlns="http://www.w3.org/2000/svg">
                <!-- Bill To Information -->
                <text x="195" y="940" font-family="Arial, sans-serif" font-size="44" fill="black">${data.billTo.name}</text>
                <text x="195" y="1000" font-family="Arial, sans-serif" font-size="48" fill="black">${data.billTo.address1}</text>
                <text x="195" y="1060" font-family="Arial, sans-serif" font-size="48" fill="black">${data.billTo.address2}</text>
                <text x="195" y="1120" font-family="Arial, sans-serif" font-size="48" fill="black">${data.billTo.address3}</text>
                
                <!-- Invoice Number and Date -->
                <text x="1250" y="930" font-family="Arial, sans-serif" font-size="46" fill="black">${data.invoiceNo}</text>
                <text x="1230" y="1020" font-family="Arial, sans-serif" font-size="46" fill="black">${data.date}</text>
                
                <!-- Item Details -->
                <text x="210" y="1500" font-family="Arial, sans-serif" font-size="46" fill="black">${data.items[0].no}</text>
                <text x="365" y="1500" font-family="Arial, sans-serif" font-size="46" fill="black">${data.items[0].itemName}</text>
                <text x="850" y="1500" font-family="Arial, sans-serif" font-size="46" fill="black">${data.items[0].rate}</text>
                <text x="1080" y="1500" font-family="Arial, sans-serif" font-size="46" fill="black">${data.items[0].qty}</text>
                <text x="1250" y="1500" font-family="Arial, sans-serif" font-size="46" fill="black">${data.items[0].amount}</text>

                <!-- Total in table -->
                <text x="1100" y="1650" font-family="Arial, sans-serif" font-size="46" font-weight="bold" fill="black">${data.items[0].qty}</text>
                <text x="1250" y="1650" font-family="Arial, sans-serif" font-size="46" font-weight="bold" fill="black">${data.items[0].amount}</text>

                <!-- Final Total -->
                <text x="1230" y="1830" font-family="Arial, sans-serif" font-size="46" font-weight="bold" fill="white">${data.total}</text>
            </svg>
        `;
        ...
        <body>
            <div class="container">
                ...
                <div class="api-examples">
                    <h2>📚 Complete API Documentation for Beginners</h2>
                    <p><strong>Welcome!</strong> This API allows you to generate invoices programmatically. Below are detailed examples for beginners.</p>
